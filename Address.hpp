...
class addr_5tup{
	...
	inline friend size_t hash_value(addr_5tup const &);	
...
class pref_addr{
	...
	inline bool hit (const size_t &) const;
	inline size_t get_extreme(bool) const;
	inline size_t get_random() const;
...
class range_addr{
	...
	inline range_addr(size_t, size_t);
	
	inline bool operator<(const range_addr &) const;
	inline bool operator==(const range_addr &) const;
	inline friend size_t hash_value(range_addr const & ra);
	...
	inline bool match (const pref_addr &) const;
	inline bool hit (const size_t &) const;
	inline void getTighter(const size_t &, const range_addr &);  // Mar 14
