...
class tracer{
	...
	void f_pg_st (fs::path, size_t, string, boost::unordered_map<addr_5tup, std::pair<size_t, addr_5tup> > *) const;
	...
	void p_count_st(fs::path, atomic_uint*, mutex *, boost::unordered_map<addr_5tup, size_t>*, atomic_bool *);
	void printTestTrace(string);

	// deprecated
	void pruning_trace_mp(string, string, string = "./TracePruning/IDtrace/ref_trace.gz");
	void p_trace_st(fs::path, string, atomic_uint*, boost::unordered_map<addr_5tup, size_t> *, atomic_bool *);
...
//	void packet_count_t(string = "./TracePruning/test_trace", string = "./TracePruning/test_trace_count.txt");
	...
	//void s_locality_st(filesystem::path, string, list<h_rule>, size_t, unordered_map<size_t, addr_5tup> *, atomic_uint*, atomic_bool *); 
